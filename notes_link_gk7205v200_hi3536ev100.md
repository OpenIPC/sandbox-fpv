...
Я скомпилировал mavfwd для регистратора, поддерживающий скорости b500000, b921600 и b1500000, для поддержки более высокой скорости при работе с Mission Planner. Для регистратора его можно забрать [здесь](https://github.com/OpenIPC/sandbox-fpv/tree/master/hi3536dv100/mavfwd). Для камеры: готовится
